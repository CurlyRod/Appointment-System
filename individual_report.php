                ...
                <td  class="text-center" ><b><?php echo $row['client_id'] ?></b></td>
                 ...
                 <td  class="text-center" ><?php echo $row['second_address'] ?></td>                   
                  ...
                  <td> 
                    ...
                    <div class="col text-center"><button class="btn btn-sm btn-info" id="view_client_individuals"  value=<?php echo $row['id']?>'><img src="./src/img/download-to-storage-drive.png"alt=""></button></div>   
                    </div>
                  </td>
